...
pub use columnar::{ColumnarBatch, ColumnarField, ColumnarSchema, ColumnarType, CopyBinaryBatchReader};
...
pub mod prelude {
    ...
    pub use crate::{ColumnarBatch, ColumnarField, ColumnarSchema, ColumnarType, CopyBinaryBatchReader};
